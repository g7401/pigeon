 ...
 * access token / 访问令牌
 */
@TinyId(bizType = AppAuthenticationDo.RESOURCE_NAME, beginId = 10, maxId = 10, step = 100, remainder = 0, delta = 1)
@EqualsAndHashCode(callSuper=false)
@Data
@Entity
@Table(name = "bo_app_authentication")
@Where(clause = "is_deleted=" + DatabaseConstants.NOT_DELETED_FLAG)
public class AppAuthenticationDo extends BaseDo {
    public static final String RESOURCE_NAME = "bo_app_authentication";
