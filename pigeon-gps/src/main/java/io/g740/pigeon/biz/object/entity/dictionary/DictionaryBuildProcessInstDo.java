 ...
 * 字典构建流程实例
 */
@TinyId(bizType = DictionaryBuildProcessInstDo.RESOURCE_NAME, beginId = 10, maxId = 10, step = 100, remainder = 0, delta = 1)
@EqualsAndHashCode(callSuper=false)
@Data
@Entity
@Table(name = "bo_dictionary_build_process_inst")
@Where(clause = "is_deleted=" + DatabaseConstants.NOT_DELETED_FLAG)
public class DictionaryBuildProcessInstDo extends BaseDo {
    public static final String RESOURCE_NAME = "bo_dictionary_build_process_inst";
