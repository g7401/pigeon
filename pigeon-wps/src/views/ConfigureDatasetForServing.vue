<template>
  <div class="confg-dataset">
    <a-card>
      ...
      <!-- <FormTableSetting :dfKey="saveDataFacetKey" v-if="saveDataFacetKey"></FormTableSetting> -->
      <a-modal
      ...
      >
        <a-row :gutter="18">
          ...
          >
            <a-col
              :span="item.type === 'DATE_TIME_RANGE' ? 12 : 6"
            ...
            >
              <a-form-model-item :label="item.key">
                ...
                <a-row v-if="item.type==='DATE_TIME_RANGE'">
                  <a-col :span="5">
                    <a-date-picker
  ...
  },
  {
    ...
    editRender: {
      ...
      options: [
        ...
        { label: 'DATE_TIME_RANGE', value: 'DATE_TIME_RANGE' },
...
export default {
  ...
  methods: {
    ...
    async save () {
      ...
      if (respone.success) {
        ...
        this.$router.push({
          ...
          query: {
            dataFacetKeyForServing: this.saveDataFacetKey,
    ...
    async getTableSetting () {
      ...
      if (response.success) {
        this.dataStoreIdSave = response.object.tableName
